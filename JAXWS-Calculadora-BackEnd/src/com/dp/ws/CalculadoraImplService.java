 ...
 * 
 */
@WebServiceClient(name = "CalculadoraImplService", targetNamespace = "http://ws.dp.com/", wsdlLocation = "http://localhost:8080/WS/ICalculadora?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULADORAIMPLSERVICE_QNAME = new QName("http://ws.dp.com/", "CalculadoraImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/WS/ICalculadora?wsdl");
    ...
    public ICalculadora getCalculadoraImplPort() {
        return super.getPort(new QName("http://ws.dp.com/", "CalculadoraImplPort"), ICalculadora.class);
    }
    ...
    public ICalculadora getCalculadoraImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.dp.com/", "CalculadoraImplPort"), ICalculadora.class, features);
    }
