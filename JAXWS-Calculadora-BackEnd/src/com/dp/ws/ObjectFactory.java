 ...
 * generated in the com.dp.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _Operacion_QNAME = new QName("http://ws.dp.com/", "operacion");
    private final static QName _OperacionResponse_QNAME = new QName("http://ws.dp.com/", "operacionResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.dp.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.dp.com/", name = "operacion")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.dp.com/", name = "operacionResponse")
